...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">whatcall documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/AuthScreenComponent.html" data-type="entity-link" >AuthScreenComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ResponsesChartComponent.html" data-type="entity-link" >ResponsesChartComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/ScenarioComponent.html" data-type="entity-link" >ScenarioComponent</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/UploadModalService.html" data-type="entity-link" >UploadModalService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
