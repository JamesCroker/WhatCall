...
var tsdoc_parser_1 = require("@elfsquad/tsdoc-parser");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, walk(fullPath, callback)];
                case 3:
                    // If it's a directory, go deeper
                    _a.sent();
                    return [3 /*break*/, 6];
                ...
                case 8:
                    error_1 = _a.sent();
                    console.error("Error reading directory ".concat(dir, ":"), error_1);
                    return [3 /*break*/, 9];
...
walk(targetDir, function (filePath) {
    ...
    var tsDocComments = (0, tsdoc_parser_1.parseTypeScriptFile)(filePath, undefined);
